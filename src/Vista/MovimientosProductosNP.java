 ...
 * @author Grover
 */
public class MovimientosProductosNP extends javax.swing.JInternalFrame {

    DefaultTableModel modeloBuscarProductos;
    DefaultTableModel modeloMovimientos;

    public MovimientosProductosNP(String usuario) throws Exception {
        initComponents();
...
//        new cargarComboAlmacenes(cmbAlmacenes);
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("MOVIMIENTOS DE PRODUCTOS SIN FACTURA");
        ...
        jLabel23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_Device_Manager_64px.png"))); // NOI18N
        jPanel8.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, -1, 70));

        txtFecha.setEditable(false);
        txtFecha.setBackground(new java.awt.Color(204, 0, 0));
        ...
        txtHora.setBackground(new java.awt.Color(204, 0, 0));
        ...
        txtUsuario.setBackground(new java.awt.Color(204, 0, 0));
    ...
    private void cmbOrigenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbOrigenActionPerformed
        if (!txtBuscarProducto.getText().trim().isEmpty()) {
            ...
            try {
                ...
                Logger.getLogger(MovimientosProductosNP.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
//                }
    ...
    private void LlenarTablaBuscarProductos(String nomProd, int idAlmacen) throws Exception {
        ...
        try {
            con.conectar();
            String sql = "SELECT productopresentacion.idproductopresentacion, producto.nombre, presentacion.descripcion, productopresentacion.stock2\n"
                    ...
                    + "WHERE producto.nombre LIKE '%" + nomProd + "%' AND productopresentacion.idalmacen = " + idAlmacen + " \n"
    ...
    private void restarStock() throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < numFilas; i++) {
                ...
                Double stock = new ProductoPresentacionDAO().Obtener(id).getStock2();
                System.out.println("stock: " + stock);
                double newStock = stock - cantidad;
                System.out.println("stock: " + newStock);
                String sql = "UPDATE `productopresentacion` SET `stock2`=" + newStock + " WHERE idproductopresentacion = " + id;
    ...
    private void sumarStock() throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < numFilas; i++) {
                ...
                double cantidad = Double.parseDouble(tblMovimientos.getValueAt(i, 5).toString());
                System.out.println("cantidad: " + cantidad);
                double stock = pp.getStock2();
                System.out.println("stock: " + stock);
                double newStock = stock + cantidad;
                System.out.println("stock: " + newStock);
                String sql = "UPDATE productopresentacion SET stock2 = " + newStock + " WHERE idproductopresentacion = " + pp.getIdProductoPresentacion();
...
//    private void moverProducto(int idProductoPresentacion, int cantidad, int idAlmacen){
//        try {
//            //restar stock de almacen que sale el producto
//            restarStock();
//            //sumar stock del producto a donde se traslada
//            ProductoPresentacion pp = new ProductoPresentacionDAO().Obtener(idProductoPresentacion);
